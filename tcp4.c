...
//     // Source port number (16 bits)
//     tcphdr.th_sport = htons (60); // <-------- CHANGE THIS

//     // Destination port number (16 bits)
//     tcphdr.th_dport = htons (80); // <-------- CHANGE THIS
...
int main(int argc, char **argv) {
    ...
    if (send_packet(filename, json, sock, true) < 0) {
        return -1;
    }
